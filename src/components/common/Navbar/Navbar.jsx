    ...
    <nav className="bg-gray-800 dark:bg-gray-900 text-white dark:text-gray-200 w-full fixed top-0 z-50 flex flex-col md:flex-row justify-between items-center p-4">
      <div className="flex items-center justify-between w-full md:w-auto">
        <Link to="/" className="text-2xl font-bold">
          <LazyImage src={logo} alt="Logo" className="h-10 w-15" />
        </Link>
        <button
      ...
      <div
        className={`flex flex-col md:flex-row md:space-x-8 md:items-center w-full md:w-auto transition-transform duration-300 ease-in-out ${
          mobileMenuOpen
            ...
            : "h-0 transform -translate-y-full md:translate-y-0"
      ...
      >
        <div className="flex flex-col md:flex-row md:space-x-8 md:items-center w-full md:w-auto mt-4 md:mt-0">
          <Link
            to="/home"
            className={`px-3 py-2 ${isActive("/home") ? "underline" : ""}`}
          >
            Home
          </Link>
          <Link
            to="/about"
            className={`px-3 py-2 ${isActive("/about") ? "underline" : ""}`}
          >
            About
          </Link>
          ...
          <Link
            to="/grothdevelopment"
            className={`px-3 py-2 ${
              isActive("/grothdevelopment") ? "underline" : ""
            }`}
          >
            G & D
          </Link>
          <Link
            to="/contact"
            className={`px-3 py-2 ${isActive("/contact") ? "underline" : ""}`}
          >
            Contact
          </Link>
          <Link
            to="/career"
            className={`px-3 py-2 ${isActive("/career") ? "underline" : ""}`}
          >
            Career
          </Link>
        </div>
