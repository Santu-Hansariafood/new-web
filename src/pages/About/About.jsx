  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center w-full px-4 py-8 md:py-16">
      <div className="md:w-1/2 flex justify-center md:justify-start mb-8 md:mb-0">
        <img src={logo} alt="About Hansaria Food" className="" />
      </div>
      <div className="md:w-1/2 flex flex-col justify-center text-center md:text-left">
        ...
        <p className="mb-4">
          ...
          and powered by technology, we offer a diverse range of premium
          paddy, wheat, and vegetable seeds.
        </p>
        ...
        <p className="mb-4">
          Dive deep into our legacy, explore our range of products, and
          discover how we’re shaping the future of farming. Join us as we sow
          the seeds of tomorrow, ensuring a bountiful, prosperous harvest for
          all.
        </p>
