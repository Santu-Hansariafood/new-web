...
const About = ({ darkMode }) => {
  ...
  return (
    <div
      className={`flex flex-col md:flex-row items-center justify-center w-full px-4 py-8 md:py-16 ${
    ...
    >
      ...
      <div className="md:w-1/2 flex flex-col justify-center text-center md:text-left">
        ...
        <button
          className={`mt-4 px-4 py-2 md:px-6 md:py-2 rounded-full text-sm md:text-base ${
            darkMode
              ? "bg-green-600 text-white hover:bg-yellow-600"
